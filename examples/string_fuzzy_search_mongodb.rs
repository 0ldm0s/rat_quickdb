...
async fn demonstrate_string_fuzzy_search() -> Result<(), Box<dyn std::error::Error>> {
    println!("\n=== 字符串模糊搜索演示 ===");
    println!("演示 MongoDB 中的字符串模糊搜索功能：");
    ...
    println!("MongoDB 原生查询: db.string_search_users.find({{ username: /wang/ }})");
    ...
    println!("MongoDB 原生查询: db.string_search_users.find({{ username: /^alice/ }})");
    ...
    println!("MongoDB 原生查询: db.string_search_users.find({{ email: /.com$/ }})");
    ...
    println!("MongoDB 原生查询: db.string_search_users.find({{ username: /.*_wang|_chen.*/ }})");
    ...
    println!("MongoDB 原生查询:");
    println!("  db.string_search_users.find({{");
    println!("    username: /wang/,");
    println!("    email: /^example/");
    println!("  }})");
    ...
    println!("MongoDB 原生查询: db.string_search_users.find({{ username: {{ $ne: 'david' }} }})");
...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    // 初始化数据库（使用与 query_operations_mongodb.rs 相同的连接配置）

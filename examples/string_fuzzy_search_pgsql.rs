//! PostgreSQL 字符串模糊搜索功能演示
//!
//! 本示例专门演示 PostgreSQL 中的字符串模糊搜索功能：
...
async fn demonstrate_string_fuzzy_search() -> Result<(), Box<dyn std::error::Error>> {
    ...
    println!("PostgreSQL 原生查询: SELECT * FROM string_search_users WHERE username LIKE '%wang%'");
    ...
    println!("PostgreSQL 原生查询: SELECT * FROM string_search_users WHERE username LIKE 'alice%'");
    ...
    println!("PostgreSQL 原生查询: SELECT * FROM string_search_users WHERE email LIKE '%.com'");
    ...
    println!("PostgreSQL 原生查询: SELECT * FROM string_search_users WHERE username ~ '.*_wang|_chen.*'");
    ...
    println!("PostgreSQL 原生查询: SELECT * FROM string_search_users WHERE username <> 'david'");
    ...
    println!("  • Ne          - 不等于（精确排除）");
    println!("\n💡 提示：PostgreSQL 使用 LIKE 和正则表达式操作符(~)实现字符串模糊搜索");
    println!("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n");
...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    println!("=== PostgreSQL 字符串模糊搜索功能演示 ===");
    ...
    // 初始化数据库（使用与 query_operations_pgsql.rs 相同的连接配置）

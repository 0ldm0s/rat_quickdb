...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    println!("mongosh \"mongodb://testdb:testdb123456@db0.0ldm0s.net:27017/testdb?authSource=testdb&tls=true&tlsInsecure=true\" --eval \"use testdb; db.json_array_test.find().pretty()\"");

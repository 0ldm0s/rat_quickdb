...
async fn demonstrate_string_fuzzy_search() -> Result<(), Box<dyn std::error::Error>> {
    ...
    println!("MySQL 原生查询: SELECT * FROM string_search_users WHERE username LIKE '%wang%'");
    ...
    println!("MySQL 原生查询: SELECT * FROM string_search_users WHERE username LIKE 'alice%'");
    ...
    println!("MySQL 原生查询: SELECT * FROM string_search_users WHERE email LIKE '%.com'");
    ...
    println!("MySQL 原生查询: SELECT * FROM string_search_users WHERE username REGEXP '.*_wang|_chen.*'");
    ...
    println!("MySQL 原生查询: SELECT * FROM string_search_users WHERE username != 'david'");
    ...
    println!("  • Ne          - 不等于（精确排除）");
    println!("\n💡 提示：MySQL 使用 LIKE 和 REGEXP 实现字符串模糊搜索");
    println!("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n");
...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    // 初始化数据库（使用与 query_operations_mysql.rs 相同的连接配置）
